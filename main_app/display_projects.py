	...
	'list': [
		{
			...
			'template': 'tools/MazeDescription.html',
			'display_main': True,
			'mobile_friendly': True,
		},	{
			'name': 'Dijkstra Algorithm',
			'template': 'tools/DijkstraDescription.html',
			'display_main': False,
			'mobile_friendly': True,
		},	{
			...
			'template': 'tools/FactorizerDescription.html',
			'display_main': True,
			'mobile_friendly': True,
		},	{
		# 	'name': 'Image Editor',
		...
		# },	{
			...
			'template': 'tools/GrapherDescription.html',
			'display_main': True,
			'mobile_friendly': True,
		},	{
			...
			'template': 'tools/HappyNumberDescription.html',
			'display_main': True,
			'mobile_friendly': True,
		},	{
			'name': 'Text Reverser',
			...
			'template': 'tools/TetxReversre.html',
			'display_main': True,
			'mobile_friendly': True,
		},	{
			...
			'template': 'tools/PasswordGeneratorDescription.html',
			'display_main': True,
			'mobile_friendly': True,
		},
	],
